...
function guiManager()
{
    ...
    {
        return "rgb(37, 94, 255)";
    };

    this.getInactiveWindowHeaderBg = function()
    {
        return "rgb(174, 217, 255)";
    }

    this.getActiveWindowHeaderTextColor = function()
    {
        return "white";
    };

    this.getInactiveWindowHeaderTextColor = function()
    {
        return "black";
    };
    ...
    {
        return "border:"+this.getContainerBorderWidth()+"px dotted;"//"";//
    };
    ...
    this.getDockBorderBgColor = function()
    {
