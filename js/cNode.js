...
function cNode(id,parent,windowObj,position)
{
    ...
    this.createContainer = function()
    {
            ...
            * Theoretically, a floated element with an undefined width
            * should shrink to the widest element within it. This could be a
            * word, a sentence or even a single character - and
            * results can vary from browser to browser.
            * The overflow hidden is strictly necessary for firefox to render
            * the divs correctly
            */
    ...
    /*
     * this method needs to be called everytime a  node is resized
     */
    ...
    this.getHotspot = function(abscoords)
    {
        var p = this.getRelativeCoords(abscoords);
        var point = [p.x, p.y];
