...
function jsWindow(idWindow, parentObj, title, width, height,icon,posx,posy)
{
    ...
    this.Dock = function(bool)
    {
        ...
        this.storeZIndex(bool);
    };

    this.storeZIndex = function(bool)
    {
        if(bool) {
            this.zIndex=this.HTMLObject.style.zIndex;
            this.HTMLObject.style.zIndex="auto";
        } else {
            this.HTMLObject.style.zIndex=this.zIndex;
        }
    };
    ...
    this.setActiveLook = function()
    {
        ...
        if (h !== null)
        {
            ...
            h.style.color = myGuiManager.getActiveWindowHeaderTextColor();
        }
    }
    this.setInactiveLook = function()
    {
        ...
        if (h != null)
        {
            ...
            h.style.color = myGuiManager.getInactiveWindowHeaderTextColor();
        }
    }
    ...
    this.createCode = function()
    {
        ...
        iconImageTag = "<img src='"+this.icon+"' align='left' onmousedown='return false' style='padding-top:2px;'>"

        dragImageTag = "<img id='"+this.idWindow+"_drag"+"' src='"+myGuiManager.getWindowDragImage()+"'; style='cursor:move;padding-top:1px;' align='left' onmousedown=\"return dragWindow(\'"+this.idWindow+"\');\">"

        titleDivTag = "<div id ='"+this.idWindow+"_title' style='white-space:nowrap;float:left; cursor:default;text-overflow : ellipsis; overflow : hidden; width:60%; padding-left:5px; font-size:13px; line-height:"+myGuiManager.getWindowHeaderHeight()+"px' onmousedown='return false;'>"
