...
function cTree(mainContainer)
{
	...
	//Inserts a new node in a given container, this container already contains a  
	//window, so this window is moved down one level (to another new node)  next to the new node
	...
	{	
	/*
	 * removes the given node/window and makes the sibling node take the position of the parent.
	 * 
	 * 
	 */	
		//get sibling node
